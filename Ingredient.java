...
public class Ingredient {
    ...
    //For the main GUI, populates the combo box for ingredients in the fridge tab
    ...
    //For the AddRecipeGUI, populates the table.
    public ArrayList<String> populateIngredientsTable() {
        conn = ConnectDB.setupConnnection();
        ...
        try {
            ...
            while (rs.next()) {
                ingredientNames.add(rs.getString("ingredient_name"));
            }
        } catch (Exception e) {
            System.out.println(e);
        } finally {
